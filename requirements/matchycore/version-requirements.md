# Matchycore Version Requirements

## Scope

Applies to `src/core/include/matchycore/version.hpp`, and `src/core/src/version.cpp`.
...
Tests:
- R001-T01: Run `bats tests/sh/version.bats` and verify scoped `#R001:` tags exist for all scope paths.
