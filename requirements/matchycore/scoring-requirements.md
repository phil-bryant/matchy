# Matchycore Scoring Requirements

## Scope

Applies to `src/core/include/matchycore/scoring.hpp`, and `src/core/src/scoring.cpp`.
...
Tests:
- R001-T01: Run `bats tests/sh/scoring.bats` and verify scoped `#R001:` tags exist for all scope paths.
