# Matchycore Settings Requirements

## Scope

Applies to `src/core/include/matchycore/settings.hpp`, and `src/core/src/settings.cpp`.
...
Tests:
- R001-T01: Run `bats tests/sh/settings.bats` and verify scoped `#R001:` tags exist for all scope paths.
