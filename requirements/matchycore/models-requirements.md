# Matchycore Models Requirements

## Scope

Applies to `src/core/include/matchycore/models.hpp`.
...
Tests:
- R001-T01: Run `bats tests/sh/models.bats` and verify scoped `#R001:` tags exist for all scope paths.
