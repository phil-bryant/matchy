# t08 run mutation tests Wrapper Requirements

## Scope

Applies to `tests/t08_run_mutation_tests.sh`. Thin pointer that selects the matchy runbook profile and delegates the lane to the runner golden via the shared shim.
