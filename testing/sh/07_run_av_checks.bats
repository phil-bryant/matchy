#!/usr/bin/env bats
# Numbered traceability tags: #R001-T01 #R005-T01 #R010-T01 #R015-T01 #R020-T01 #R020-T02 #R025-T01 #R030-T01 #R030-T02 #R035-T01 #R040-T01 #R045-T01 #R050-T01
...
@test "fails when clamscan is missing" {
  ...
  run env PATH="/usr/bin:/bin" bash "${FIXTURE_ROOT}/07_run_av_checks.sh"
  [ "$status" -ne 0 ]
