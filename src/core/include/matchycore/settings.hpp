...
{ class Settings
 { public:
  ...
  [[nodiscard]] const std::string &anthropic_api_key_item() const { return anthropic_api_key_item_; }
  [[nodiscard]] const std::string &openai_api_key_item() const { return openai_api_key_item_; }
  ...
  void set_anthropic_api_key_item(std::string v) { anthropic_api_key_item_ = std::move(v); }
  void set_openai_api_key_item(std::string v) { openai_api_key_item_ = std::move(v); }
  ...
  std::string anthropic_api_key_item_ = "anthropic_api_key";
  std::string openai_api_key_item_ = "openai_api_key";
